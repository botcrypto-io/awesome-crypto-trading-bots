...
* [DeepAlpha](https://github.com/stefanoviana/deepalpha) - An AI-powered crypto trading bot with 3-model ML ensemble (XGBoost, HMM, Transformer), 70.9% walk-forward accuracy, supporting 12 exchanges including Bybit, Binance, OKX, and more. Features cloud platform with dashboard, backtesting, and TradingView webhooks.
