...
* [TrendRider](https://trendrider.net) - A free and open-source Freqtrade-based crypto trading bot for Bybit with multi-timeframe analysis, 67.9% win rate, dynamic position sizing, and support for 15+ altcoins.
