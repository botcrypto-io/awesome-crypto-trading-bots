...
* [FillBench](https://fillbench.com) - Reproducible benchmarks for crypto exchange REST API latency (p50/p95/p99, TLS connect time) and true cost to trade (taker fee + measured spread + slippage), re-measured every 2h from a fixed US-East host. Open JSON + CC BY 4.0 data.
